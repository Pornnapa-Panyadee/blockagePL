                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title">รายงานสภาพและแนวทางการแก้ไขปัญหา</h2>
                        ...
                        <div class="card-body" >
                            <div class="row" style="padding-left:30px;">
                                ...
                                <h5 ><a href="{{ asset('/') }}">หน้าแรก </a>  &raquo; รายงานสรุปสภาพปัญหาและแนวทางการแก้ไข</h5>
                            </div>
                            <br><BR>
                            <div class="flex-center position-ref full-height">
                                <div class="content">
                                   ...
                                   <div class="title m-b-md">
                                        <form id="amp" name="amp" action='{{ route('report/pdf/amp') }}' method="get"> 
                                           {{-- {{ csrf_field() }} --}}
