            ...
            <div class="flex-center position-ref full-height">
                ...
                <div class="content">
                    ...
                    <div class="title m-b-md form-group">
                        ...
                        <form action="{{asset('edit/B00001')}}" method="get" onsubmit="return confirm('แก้ไข เรียบร้อย !!');">
                            ...
                            <table style="margin-left:10px;" class="table table-borderless">
                                ...
                                <tr>
                                    <td></td>
                                    <td><input type="text" id="latstart" name="latstart" placeholder="Latitude"  value='{{ $obj[$id]->blockage_location->blk_start_location->coordinates[0] ?? "" }}' required >
                                        <div class="invalid-feedback"></div>
                                    </td>
                                    <td><input type="text" id="longstart" name="longstart" placeholder="Longitude" value='{{ $obj[$id]->blockage_location->blk_start_location->coordinates[1] ?? "" }}' required >
                                        <div class="invalid-feedback"></div>
                                    </td>
                                ...
                                <tr>
                                    <td></td>
                                    <td><input type="text" id="latend" name="latend" placeholder="Latitude" value='{{ $obj[$id]->blockage_location->blk_end_location->coordinates[0] ?? "" }}' required  >
                                        <div class="invalid-feedback"></div>
                                    </td>
                                    <td><input type="text" id="longend" name="longend" placeholder="Longitude" value='{{ $obj[$id]->blockage_location->blk_end_location->coordinates[1] ?? "" }}' required >
                                        <div class="invalid-feedback"></div>
                                    </td>
                                            ...
                                            <div id="showculvert" class="myDiv" style="background-color:#fff;">
                                                <table align="center">
                                                    <tr> 
                                                        ...
                                                        <td><input type="radio" id="culvert_round" value="round" name="current_narrow[culvert]" required onclick="culvertValidate()"><label for="culvert_round">ท่อกลม</label></td>
                                                    ...
                                                    <?php if(isset($blk_crossection_current_narrow->culvert->diameter)){?>
                                                        <td><input type="number" id="num_culvert1" name="current_narrow[culvert][num]" step="any" placeholder="จำนวนท่อ (ช่อง)" value='{{ $blk_crossection_current_narrow->culvert->num ?? "" }}'  disabled> </td>
                                                    <?php }else{ ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td ><input type="number" id="width_culvert" name="current_narrow[culvert][width]" placeholder="กว้าง (ม.)" value='{{ $blk_crossection_current_narrow->culvert->width ?? "" }}' disabled></td>
                                                        <td ><input type="number" id="high_culvert" name="current_narrow[culvert][high]" placeholder="สูง (ม.)" value='{{ $blk_crossection_current_narrow->culvert->high ?? "" }}'  disabled></td>
                                                    <?php if(isset($blk_crossection_current_narrow->culvert->width )){?>
                                                        <td ><input type="number" id="num_culvert2" name="current_narrow[culvert][num]" placeholder="จำนวนท่อ (ช่อง)" step="any" value='{{ $blk_crossection_current_narrow->culvert->num ?? "" }}' disabled></td>
                                                    <?php }else{ ?>
                                ...
                                <tr >
                                    ...
                                    <td >
                                        <select id="blk_length" name="blk_length" class="blk_length_div" value='{{ $obj[$id]->blk_length ?? "" }}'>
                                            <option value="{{$obj[$id]->blk_length}}">{{$obj[$id]->blk_length}}</option>
                            ...
                            <table class="table table-form table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input type="text" id="blk_surface_detail" name="blk_surface_detail" placeholder="ระบุวัสดุ" value='{{ $obj[$id]->blk_surface_detail ?? "" }}' disabled>
                                        <div class="invalid-feedback"></div>
                                    </td>
                            ...
                            <table align="center"  class="table-damages table-borderless" width="80%">
                                ...
                                <tr align="center">
                                    ...
                                    <td ><input type="hidden" name="damage_level[flood]" value="0">
                                        <input type="radio" id="damageflood1" name="damage_level[flood]" value="low" disabled/><label for="damageflood1">น้อย</label></td>
                                ...
                                <tr align="center">
                                    ...
                                    <td><input type="hidden" name="damage_level[waste]" value="0">
                                        <input type="radio" id="damagewaste1" name="damage_level[waste]" value="low" disabled/><label for="damagewaste1"> น้อย </label></td>
                           ...
                           {{-- ข้อ 3 สภาพปัญหา --}}
                            ...
                            <table align="center" class="table table-form table-borderless" >
                                ...
                                <?php if($blk_problem_detail[$id]->hum_str_owner_type=="ราชการ"){
                                    ...
                                    $bld_bu=$blk_problem_detail[$id]->hum_stc_bld_num;
                                    $fence_bu=$blk_problem_detail[$id]->hum_stc_fence_num;
                                    $other_bu=$blk_problem_detail[$id]->hum_str_other ;
                                    $bld_gov=null;
                                    $fence_gov=null;
                                    $other_gov=null ;
                                }?>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <table align="center" class="table table-form table-borderless">
                                            <tr>
                                                <td >ส่วนของอาคาร</td><td> <input type="text" id="hum_stc_bld_num" name="hum_stc_bld_num" placeholder="ระบุ (หลัง)" value='{{ $bld_bu }}'> </td>
                                                <td >รั้ว</td><td><input type="text" id="hum_stc_fence_num" name="hum_stc_fence_num" placeholder="ระบุ  (หลัง)" value='{{ $fence_bu ?? "" }}'> </td>
                                                <td >อื่นๆ </td><td><input type="text" id="hum_str_other" name="hum_str_other" placeholder="ระบุ" value='{{$other_bu}}' ></td>
                                ...
                                <tr>
                                    <td style="padding-left:40px;"><input type="checkbox" id="hum_road" name="hum_road" value='{{ $blk_problem_detail[$id]->hum_road ?? "" }}'/><label for="hum_road">ถนนขวางทางน้ำ </label></td>
                                    <td style="padding-left:40px;"><input type="checkbox" id="hum_smallconvert" name="hum_smallconvert"  value='{{ $blk_problem_detail[$id]->hum_smallconvert ?? "" }}'/><label for="hum_smallconvert">ท่อลอดถนนที่ตัดลำน้ำมีขนาดเล็กเกินไประบายน้ำหลากไม่ทัน</label></td>
                                </tr>
                                <tr>
                                        <td style="padding-left:40px;"><input type="checkbox" id="hum_road_paralel" name="hum_road_paralel" value='{{ $blk_problem_detail[$id]->hum_road_paralel ?? "" }}' /> <label for="hum_road_paralel">ถนนขนานลำน้ำสร้างกินพื้นที่ลำน้ำ </label></td>
                                        <td style="padding-left:40px;"><input type="checkbox" id="hum_replaced_convert" name="hum_replaced_convert" value='{{ $blk_problem_detail[$id]->hum_replaced_convert ?? "" }}'/><label for="hum_replaced_convert">วางท่อตามแนวลำน้ำทดแทนลำน้ำเดิม</label></td>
                                 </tr>
                                <tr>
                                    <td style="padding-left:40px;" colspan="2"> <input type="checkbox" id="hum_bridge_pile" name="hum_bridge_pile" value='{{ $blk_problem_detail[$id]->hum_bridge_pile ?? "" }}' /><label for="hum_bridge_pile">สะพานมีหน้าตัดแคบเกินไป หรือมีต่อม่อมากเกินไปในช่วงฤดูน้ำหลากระบายไม่ทัน</label></td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom:10px;"></td>
                                </tr>
                                <tr>
                                    <td ><input type="checkbox" id="hum_soil_cover" name="hum_soil_cover" value='{{ $blk_problem_detail[$id]->hum_soil_cover ?? "" }}' /><label for="hum_soil_cover">การถมดิน </label></td>
                                 </tr>
                                <tr>
                                    <td ><input type="checkbox" id="hum_trash" name="hum_trash" value='{{ $blk_problem_detail[$id]->hum_trash ?? "" }}' /><label for="hum_trash">สิ่งปฏิกูล </label></td>
                                </tr>
                                <tr>
                            ...
                            <table align="center" class="table table-form table-borderless">
                                ...
                                <td colspan="6"><input type="text" id="responsed_dept" name="responsed_dept" required value="{{$solution[0]->responsed_dept}}">
                                        <div class="invalid-feedback"></div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:40px;"><input type="radio" id="sol_how2" name="sol_how" value="เจรจาให้รื้อถอน" required onclick="solHowValidate()" ><label for="sol_how2">เจรจาให้รื้อถอน</label></td>
                                    ...
                                    <td colspan="5">
                                        <div id="showplan" class="myDiv" style="background-color:#fff;padding-top:30px;padding-bottom:30px;">
                                            <table align="center" >
                                                ...
                                                <tr>
                                                    <td>ลักษณะโครงการ: </td>
                                                    <td><input type="number" id="proj_year" name="proj_year" step="any" placeholder="ระบุปี พ.ศ" value='{{ $blk_project->proj_year  }}'></td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                ...
                                                <tr>
                                                    <td>งบประมาณ: </td>
                                                    <td><input type="number" id="proj_budget" name="proj_budget" step="any" placeholder="ระบุงบประมาณ" value='{{ $blk_project->proj_budget }}'></td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div id="showreceived" class="myDiv" style="background-color:#fff;padding-top:10px;padding-bottom:30px;">
                                            <table align="center">
                                                ...
                                                <tr>
                                                    <td>งบประมาณ: </td>
                                                    <td><input type="number" id="proj_budget2" name="proj_budget2" step="any" placeholder="ระบุงบประมาณ" value='{{ $blk_project->proj_budget }}'></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </td>
