                        ...
                        <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12" align="right">
                                        <a href="{{ url('/') }}"><button class="btn btn-sm btn-outline-light " >
                                            ...
                                            <a href='{{ asset('/reportblockage/pdf/') }}/{{$data[0]->blk_id}}' ><button class="btn btn-sm btn-outline-light " >
                 ...
                 {{-- ข้อ1    --}}
                                             <br>
                                              ...
                                              <table class="table-report2" width="80%" align="center">
                                                  <tr >
                                                      <td align="right" >กว้าง <font class="line">{{ checkZero($pastData->width)}} &nbsp;</font> เมตร </td>
                                                      <td align="right">ลึก <font class="line">{{checkZero($pastData->depth) }} &nbsp;</font> เมตร</td>
                                                      <td align="center"> ความลาดชันของตลิ่ง <font class="line">{{ checkZero($pastData->slop) }}&nbsp;</font>  เมตร</td>
                                            ...
                                            <table class="table-report2" width="80%" align="center">
                                                ...
                                                <tr >
                                                    <td align="right">กว้าง <font class="line">{{ checkZero($current_start->width) }} &nbsp;</font> เมตร </td>
                                                    <td align="right">ลึก <font class="line">{{ checkZero($current_start->depth) }} &nbsp;</font> เมตร</td>
                                                    <td align="center"> ความลาดชันของตลิ่ง <font class="line">{{checkZero($current_start->slop) }}</font>&nbsp;  เมตร</td>
                                                </tr>
                                                <tr>
                                            ...
                                            <table class="table-report3" width="80%" align="center">
                                                ...
                                                <tr >
                                                    ...
                                                    <td width=5% class="line" align="center">{{ checkZero($current_narrow_new->waterway->width )}} </td>
                                                    <td>เมตร  </td> 
                                                    <td align="right"> ลึก</td>
                                                    <td width=5% class="line" align="center">{{ checkZero($current_narrow_new->waterway->depth) }} </td>
                                                    <td>เมตร  </td>
                                                    <td align="center"> ความลาดชันของตลิ่ง</td>
                                                    <td width=5% class="line" align="center">{{ checkZero($current_narrow_new->waterway->slop) }} </td>
                                                    <td>เมตร  </td>
                                                ...
                                                <tr >
                                                    ...
                                                    <td> สะพาน </td>
                                                    <td align="right"> กว้าง </td>
                                                    <td width=5% class="line" align="center">{{ checkZero($current_brigde->width)}} </td>
                                                    <td>เมตร  </td> 
                                                    <td align="right"> ลึก</td>
                                                    <td width=5% class="line" align="center">{{ checkZero($current_brigde->depth) }} </td>
                                                    <td>เมตร  </td>
                                                    <td align="right"> ความยาวช่วงตอม่อ</td>
                                                    <td width=5% class="line" align="center">{{ checkZero($current_brigde->len) }} </td>
                                                    <td>เมตร  </td>
                                                    <td align="right"> จำนวนตอม่อ</td>
                                                    <td width=5% class="line" align="center">{{ checkZero($current_brigde->num) }} </td>
                                                    <td>แถว  </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>ช่อง </td>  
                                                    <td align="right"> ความยาว</td>
                                                    <td class="line" align="center">{{ checkZero($current_narrow_new->square->len)}} </td>
                                                    <td>เมตร </td>
                                            ...
                                            <table class="table-report2" width="80%" align="center">
                                                ...
                                                <tr >
                                                    <td align="right">กว้าง <font class="line">{{ checkZero($current_end->width)  }} &nbsp;</font> เมตร </td>
                                                    <td align="right">ลึก <font class="line">{{ checkZero($current_end->depth)}} &nbsp;</font> เมตร</td>
                                                    <td align="right"> ความลาดชันของตลิ่ง <font class="line">{{ checkZero($current_end->slope) }}&nbsp;</font>  เมตร</td>
                                                </tr>
                                            </table>
                                            <table class="table-report1" width="90%" align="center">
                                                ...
                                                ?>
                                                    <tr>
                                                        <td colspan="2">1.5 ความยาวของช่วงลำน้ำที่เกิดปัญหา <font class="line">{{checkZero($lenght)}} &nbsp;</font></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">1.7 ความลาดชันท้องน้ำช่วงที่เกิดปัญหา &nbsp;&nbsp;&nbsp;<font class="line"> {{checkZero($data[0]->blk_slope_bed)}} &nbsp;&nbsp;</font></td>
                                                    </tr>
                                            </table>
                                         {{-- ข้อ2   --}}
                                         <br>
                                        ...
                                        <table class="table-report3" width="70%" align="center">
                                            ...
                                            <tr>
                                                <table class="table-report1" width="70%" align="center">
                                                    ...
                                                    <tr>
                                                        <td >{{checkCuase($problem[0]->hum_trash)}}สิ่งปฏิกูล </td>
                                                    </tr>
                                                    <tr>
                                                        <td >{{checkCuase($problem[0]->hum_other)}}อื่นๆ <font class="line">{{$problem[0]->hum_other_detail}} </font></td>
                                                    </tr>
                                                </table>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $proj1?>อยู่ในแผน <font class="line">&nbsp;&nbsp;{{$project_id[0]->proj_year}}&nbsp;&nbsp;&nbsp;&nbsp;</font> ปี</td>
                                                 <td>ลักษณะโครงการ <font class="line">&nbsp;&nbsp;{{$name_plan}}&nbsp;&nbsp;&nbsp;&nbsp;</font>
                                                    งบประมาณ <font class="line">&nbsp;&nbsp;<?php if($budget_plan!=null){echo number_format($budget_plan);}?>&nbsp;&nbsp;&nbsp;&nbsp;</font> บาท
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width=20px;></td>
                                                <td><?php echo $proj2?>ได้รับงบประมาณแล้ว  <font class="line">&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</font> บาท </td>
