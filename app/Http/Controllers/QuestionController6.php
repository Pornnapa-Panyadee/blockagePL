...
class QuestionController6 extends Controller
{
    protected $photo;
    /**
    ...
    public function questionnaire6($id)
    {
        $data =  Blockage::with('blockageLocation')->where('blk_id', $id)->get();
        return view('form.questionnaire6', compact('data'));
    }
    ...
    public function uploadImage(Request $request)
    {
       ...
       function calCode($users,$text) {
        ...
        if ($request->hasFile('photo_type_prob_sketch')) {
            ...
            return redirect()->route('report.pdf', [$blk_id]);
    }
}
